...
function draw( show_num , action ){
    if( action == 1 ){
        ...
        var canvas_width = document.getElementById( 'can_code_reg' ).clientWidth;
        var canvas_height = document.getElementById( 'can_code_reg' ).clientHeight;
        var canvas = document.getElementById( 'can_code_reg' );//获取到canvas的对象，演员
    }
